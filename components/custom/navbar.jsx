...
export default async function NavBar() {
  ...
  return (
    <div className='sticky top-0 flex items-center justify-between px-8 py-4 border-b border-black/15 md:w-5/6 xl:w-2/3 lg:mx-auto bg-white dark:bg-neutral-900 dark:rounded-b-lg z-50'>
      ...
      <Sheet>
        ...
        <SheetContent side="right">
          <nav className='flex flex-col p-4 text-center text-neutral-500 dark:text-white text-xl'>
            ...
            <Link className='px-4 py-2 my-2 border-b-2 border-transparent hover:border-black/50 dark:hover:border-white/50 duration-200' href="/dashboard/invitations">Invitations</Link>
