...
export default async function NavBar() {
  ...
  return (
    <div className='sticky top-0 flex items-center justify-between px-8 py-4 border-b border-black/15 xl:w-1/2 lg:mx-auto bg-white dark:bg-neutral-900 dark:rounded-b-lg z-50'>
