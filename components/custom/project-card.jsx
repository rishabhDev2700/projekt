...
export default function ProjectCard({ id, title, description, status }) {
    return (
        <Card className="-z-50 lg:w-56 rounded-xl lg:inline-block my-2 lg:m-1 hover:scale-95 duration-200 shadow-md shadow-black/10">
            <img className='rounded-t-lg p-0 m-0 min-h-[50%] ' src="https://images.unsplash.com/photo-1721475246144-98e4f01f3a6c?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
